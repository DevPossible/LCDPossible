#!/bin/bash
# LCDPossible - Arch Linux Full Installer
# Usage: curl -sSL https://raw.githubusercontent.com/DevPossible/LCDPossible/main/scripts/install-arch.sh | bash
#
...
echo "=============================================="
echo "  LCDPossible Installer (Arch Linux)"
echo "=============================================="
echo ""
...
echo "  Checking fonts..."
if is_installed "ttf-dejavu"; then
