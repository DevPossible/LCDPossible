#!/bin/bash
# LCDPossible Uninstaller for Arch Linux
# Usage: curl -fsSL https://raw.githubusercontent.com/USER/LCDPossible/main/scripts/uninstall-arch.sh | sudo bash
#
# This script:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --quiet|-q)
            ...
            ;;
        --help|-h)
            echo "LCDPossible Uninstaller for Arch Linux"
            echo ""
...
echo ""
echo -e "${BLUE}╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║${NC}              LCDPossible Uninstaller - Arch Linux            ${BLUE}║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
info "Dependencies (vlc, ttf-dejavu, jq) were not removed."
info "Remove them manually if no longer needed:"
echo "    sudo pacman -Rs vlc ttf-dejavu jq"
echo ""
